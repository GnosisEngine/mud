...
module.exports = {
  listeners: {
    spawn: (/*state*/) => /** @this {import('types').RanvierNpc} */ function() {
      if (this.room) {
     ...
     */
    updateTick: state => /** @this {import('types').RanvierNpc} */ function() {
      if (!this.isInCombat()) {
        return;
      }
    ...
    deathblow: (/*state*/) => /** @this {import('types').RanvierNpc} */ function(player) {
